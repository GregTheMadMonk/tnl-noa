 ...
 *    \ref noa::TNL::Containers::Segments::Kernels::CSRAdaptiveKernel,
 *    \ref noa::TNL::Containers::Segments::Kernels::CSRHybridKernel,
 *    \ref noa::TNL::Containers::Segments::Kernels::CSRScalarKernel,
 *    \ref noa::TNL::Containers::Segments::Kernels::CSRVectorKernel
 *
...
class CSR
{
   public:
       ...
       *
       * \tparam SizesContainer is a type of container for segments sizes.  It can be \ref noa::TNL::Containers::Array or
       *  \ref noa::TNL::Containers::Vector for example.
       ...
       *
       * \tparam SizesContainer is a container with segments sizes. It can be \ref noa::TNL::Containers::Array or
       *  \ref noa::TNL::Containers::Vector for example.
       *
      ...
      /**
       * \brief Call \ref noa::TNL::Algorithms::Segments::CSR::forElements for all elements of the segments.
       *
      ...
      /**
       * \brief Call \ref noa::TNL::Algorithms::Segments::CSR::forSegments sequentially for particular segments.
       *
