/***************************************************************************
                          BackwardFiniteDifference.h  -  description
                             -------------------
    begin                : Jan 9, 2016
...
template< int Dimensions,
          ...
          typename Real,
          typename Index >
class BackwardFiniteDifference< tnlGrid< Dimensions, MeshReal, MeshDevice, MeshIndex >, XDifference, YDifference, ZDifference, Real, Index >
