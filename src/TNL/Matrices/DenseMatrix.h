...
#include <TNL/Matrices/DenseMatrixRow.h>
...
class DenseMatrixDeviceDependentCode;
...
class DenseMatrix : public Matrix< Real, Device, Index >
{
   ...
   typedef DenseMatrix< Real, Device, Index > ThisType;
   typedef DenseMatrix< Real, Devices::Host, Index > HostType;
   typedef DenseMatrix< Real, Devices::Cuda, Index > CudaType;
   typedef Matrix< Real, Device, Index > BaseType;
   typedef DenseMatrixRow< Real, Index > MatrixRow;
   ...
   bool setLike( const DenseMatrix< Real2, Device2, Index2 >& matrix );
   ...
   typedef DenseMatrixDeviceDependentCode< DeviceType > DeviceDependentCode;
   friend class DenseMatrixDeviceDependentCode< DeviceType >;
...
#include <TNL/Matrices/DenseMatrix_impl.h>
