...
__cuda_callable__
StaticVector< 2, Real >::StaticVector( const Expressions::BinaryExpressionTemplate< T1, T2, Operation >& op )
{
   ...
   Algorithms::VectorAssignment< StaticVector< 2, Real >, Expressions::BinaryExpressionTemplate< T1, T2, Operation > >::assignStatic( *this, op );
};
...
StaticVector< 2, Real >::StaticVector( const Expressions::UnaryExpressionTemplate< T, Operation >& op )
{
   ...
   Algorithms::VectorAssignment< StaticVector< 2, Real >, Expressions::UnaryExpressionTemplate< T, Operation > >::assignStatic( *this, op );
};
