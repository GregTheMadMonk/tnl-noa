...
{
   Algorithms::VectorAssignment< StaticVector< 2, Real >, Expressions::BinaryExpressionTemplate< T1, T2, Operation > >::assign( *this, op );
};
...
{
   Algorithms::VectorAssignment< StaticVector< 2, Real >, RHS  >::assign( *this, rhs );
   return *this;
}
