...
#include <TNL/config/tnlConfigEntryType.h>
#include <TNL/config/tnlConfigEntry.h>
#include <TNL/config/tnlConfigEntryList.h>
#include <TNL/config/tnlConfigDelimiter.h>
