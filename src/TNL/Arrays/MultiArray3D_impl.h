...
template< typename Element, typename Device, typename Index >
String tnlMultiArray< 3, Element, Device, Index > :: getType()
{
...
template< typename Element,
          typename Device,
          typename Index >
String tnlMultiArray< 3, Element, Device, Index > :: getTypeVirtual() const
{
   return this->getType();
};
...
template< typename Element,
          typename Device,
          typename Index >
String tnlMultiArray< 3, Element, Device, Index > :: getSerializationType()
{
...
template< typename Element,
          typename Device,
          typename Index >
String tnlMultiArray< 3, Element, Device, Index > :: getSerializationTypeVirtual() const
{
...
template< typename Element, typename Device, typename Index >
bool tnlMultiArray< 3, Element, Device, Index > :: setDimensions( const Vectors::tnlStaticVector< 3, Index >& dimensions )
{
...
{
   this->dimensions = Vectors::tnlStaticVector< 3, Index >( ( Index ) 0 );
...
template< typename Element, typename Device, typename Index >
__cuda_callable__
const Vectors::tnlStaticVector< 3, Index >& tnlMultiArray< 3, Element, Device, Index > :: getDimensions() const
{
...
template< typename Element, typename Device, typename Index >
bool tnlMultiArray< 3, Element, Device, Index > :: save( File& file ) const
{
...
template< typename Element, typename Device, typename Index >
bool tnlMultiArray< 3, Element, Device, Index > :: load( File& file )
{
