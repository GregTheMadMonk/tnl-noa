...
template bool tnlArrayOperations< tnlCuda >::copyMemory< char,        tnlHost,        char, int >( char* destination, const char* source, const int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< int,         tnlHost,         int, int >( int* destination, const int* source, const int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< long int,    tnlHost,    long int, int >( long int* destination, const long int* source, const int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< float,       tnlHost,       float, int >( float* destination, const float* source, const int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< double,      tnlHost,      double, int >( double* destination, const double* source, const int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< long double, tnlHost, long double, int >( long double* destination, const long double* source, const int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< char,        tnlHost,        char, long int >( char* destination, const char* source, const long int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< int,         tnlHost,         int, long int >( int* destination, const int* source, const long int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< long int,    tnlHost,    long int, long int >( long int* destination, const long int* source, const long int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< float,       tnlHost,       float, long int >( float* destination, const float* source, const long int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< double,      tnlHost,      double, long int >( double* destination, const double* source, const long int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< long double, tnlHost, long double, long int >( long double* destination, const long double* source, const long int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< char,        tnlCuda,        char, int >( char* destination, const char* source, const int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< int,         tnlCuda,         int, int >( int* destination, const int* source, const int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< long int,    tnlCuda,    long int, int >( long int* destination, const long int* source, const int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< float,       tnlCuda,       float, int >( float* destination, const float* source, const int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< double,      tnlCuda,      double, int >( double* destination, const double* source, const int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< long double, tnlCuda, long double, int >( long double* destination, const long double* source, const int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< char,        tnlCuda,        char, long int >( char* destination, const char* source, const long int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< int,         tnlCuda,         int, long int >( int* destination, const int* source, const long int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< long int,    tnlCuda,    long int, long int >( long int* destination, const long int* source, const long int size );
template bool tnlArrayOperations< tnlCuda >::copyMemory< float,       tnlCuda,       float, long int >( float* destination, const float* source, const long int size );
