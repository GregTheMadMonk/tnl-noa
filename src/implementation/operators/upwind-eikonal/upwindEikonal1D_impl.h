...
#ifndef UPWINDEIKONAL1D_IMPL_H_
#define UPWINDEIKONAL1D_IMPL_H_
...
__device__ __host__
#endif
Real upwindEikonalScheme< tnlGrid< 1, MeshReal, Device, MeshIndex >, Real, Index >:: getValue( const MeshType& mesh,
