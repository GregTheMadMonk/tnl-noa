/***************************************************************************
                          tnlSDFSinBumpsFunctionSDF_impl.h  -  description
                             -------------------
    begin                : Oct 13, 2014
...
template< typename Vertex >
void tnlSDFSinBumpsFunctionSDFBase< Vertex >::setWavesNumber( const Vertex& waveLength )
{
   this->wavesNumber = wavesNumber;
}

template< typename Vertex >
const Vertex& tnlSDFSinBumpsFunctionSDFBase< Vertex >::getWavesNumber() const
{
...
template< typename Real >
   template< int XDiffOrder,
             ...
             int ZDiffOrder,
             typename Vertex >
Real tnlSDFSinBumpsFunctionSDF< 1, Real >::getValue( const Vertex& v,
...
template< typename Real >
   template< int XDiffOrder,
             ...
             int ZDiffOrder,
             typename Vertex >
Real tnlSDFSinBumpsFunctionSDF< 2, Real >::getValue( const Vertex& v,
              const Real& time ) const
{
   const RealType& x = v.x();
...
template< typename Real >
   template< int XDiffOrder,
             ...
             int ZDiffOrder,
             typename Vertex >
Real tnlSDFSinBumpsFunctionSDF< 3, Real >::getValue( const Vertex& v,
              const Real& time ) const
{
   const RealType& x = v.x();
   const RealType& y = v.y();
