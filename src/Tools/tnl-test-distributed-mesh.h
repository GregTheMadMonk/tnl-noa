/***************************************************************************
                          tnl-distributed-mesh-test.cpp  -  description
                             -------------------
    begin                : Oct 18, 2020
...
struct MeshConfigTemplateTag< MyConfigTag >
{
   ...
   struct MeshConfig
   {
      ...
      {
//         return false;
         return (EntityTopology::dimension == 0 || EntityTopology::dimension == meshDimension - 1) && SuperentityDimension >= meshDimension - 1;
      }
