...
class tnlCoordinates : public tnlVector< Dimensions, Index >
{
};

template< typname Index >
class tnlCoordinates< 1, Index > : public tnlVector< 1, Index >
{
...
template< typname Index >
class tnlCoordinates< 2, Index > : public tnlVector< 1, Index >
{
   Index getGridSize() const;
...
template< typname Index >
class tnlCoordinates< 3, Index > : public tnlVector< 1, Index >
{
   Index getGridSize() const;
