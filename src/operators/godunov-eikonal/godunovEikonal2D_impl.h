...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
bool godunovEikonalScheme< tnlGrid< 2,MeshReal, Device, MeshIndex >, Real, Index > :: init( const tnlParameterContainer& parameters )
{
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
tnlString godunovEikonalScheme< tnlGrid< 2, MeshReal, Device, MeshIndex >, Real, Index > :: getType()
{
