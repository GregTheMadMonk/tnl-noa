                       ...
                       DofVectorType& fu ) const
{
   ...
   if( entity.getCoordinates().x() == 0 )
      u[ index ] = u[ neighbourEntities.template getEntityIndex< 1 >() ] - mesh.getHx() * this->vector[ index ];
   else
      u[ index ] = u[ neighbourEntities.template getEntityIndex< -1 >() ] + mesh.getHx() * this->vector[ index ];
}
                       ...
                       DofVectorType& fu ) const
{
   ...
   if( entity.getCoordinates().x() == 0 )
   {
      u[ index ] = u[ neighbourEntities.template getEntityIndex< 1, 0, 0 >() ] - mesh.getHx() * this->vector[ index ];
      return;
   }
   if( entity.getCoordinates().x() == mesh.getDimensions().x() - 1 )
   {
   ...
   if( entity.getCoordinates().y() == 0 )
   {
      u[ index ] = u[ neighbourEntities.template getEntityIndex< 0, 1, 0 >() ] - mesh.getHy() * this->vector[ index ];
      return;
   }
   if( entity.getCoordinates().y() == mesh.getDimensions().y() - 1 )
   {
   ...
   {
      u[ index ] = u[ neighbourEntities.template getEntityIndex< 0, 0, 1 >() ] - mesh.getHz() * this->vector[ index ];
      return;
   }
