                          ...
                          TimeFunction& timeFunction,AnalyticSpaceFunction& analyticSpaceFunction)
{
   ...
   u[0] = timeFunction.getTimeValue(time)*analyticSpaceFunction.getF(vertex);
   
   mesh.getElementCoordinates(u.getSize()-1,coordinates);
   mesh.getElementCenter(coordinates,vertex);

   u[u.getSize()-1] = timeFunction.getTimeValue(time)*analyticSpaceFunction.getF(vertex);
}
                            ...
                            TimeFunction& timeFunction, AnalyticSpaceFunction& analyticSpaceFunction)
{
   ...
   u[0] = timeFunction.getDerivation(time)*analyticSpaceFunction.getF(vertex);
   
   mesh.getElementCoordinates(u.getSize()-1,coordinates);
   mesh.getElementCenter(coordinates,vertex);

   u[u.getSize()-1] = timeFunction.getDerivation(time)*analyticSpaceFunction.getF(vertex);
}
