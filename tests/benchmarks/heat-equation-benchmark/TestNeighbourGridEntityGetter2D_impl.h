...
#include "TestGridEntityGetter.h"
...
class TestNeighbourGridEntityGetter< 
   TestGridEntity< tnlGrid< 2, Real, Device, Index >, 2, Config >,
   2,
   StencilStorage >
{
   public:
      ...
      typedef TestGridEntity< GridType, NeighbourEntityDimensions, Config > NeighbourGridEntityType;
      typedef Real RealType;
      typedef Index IndexType;
      typedef typename GridType::CoordinatesType CoordinatesType;
      typedef TestGridEntityGetter< GridType, NeighbourGridEntityType > GridEntityGetter;

      __cuda_callable__ inline
      TestNeighbourGridEntityGetter( const GridEntityType& entity )
      : entity( entity )
      {}
...
template< typename Real,
          ...
          typename StencilStorage >
class TestNeighbourGridEntityGetter< 
   TestGridEntity< tnlGrid< 2, Real, Device, Index >, 1, Config >,
   2,
   StencilStorage >
{
   public:
...
template< typename Real,
          ...
          typename StencilStorage >
class TestNeighbourGridEntityGetter< 
   TestGridEntity< tnlGrid< 2, Real, Device, Index >, 0, Config >,
   0,
   StencilStorage >
{
   public:
