/***************************************************************************
                          TestGridEntityGetter_impl.h  -  description
                             -------------------
    begin                : Nov 15, 2015
...
#include <mesh/grids/TestGridEntityGetter.h>
...
template< typename Real,
          ...
          typename Index,
          typename GridEntity >
class TestGridEntityGetter< tnlGrid< 2, Real, Device, Index >, GridEntity, 2 >
{
   public:
...
template< typename Real,
          ...
          typename Index,
          typename GridEntity >
class TestGridEntityGetter< tnlGrid< 2, Real, Device, Index >, GridEntity, 1 >
{
   public:
...
template< typename Real,
          ...
          typename Index,
          typename GridEntity >
class TestGridEntityGetter< tnlGrid< 2, Real, Device, Index >, GridEntity, 0 >
{
   public:
...
template< typename Real,
          ...
          typename Index,
          typename GridEntity >
class TestGridEntityGetter< tnlGrid< 3, Real, Device, Index >, GridEntity, 3 >
{
   public:
...
template< typename Real,
          ...
          typename Index,
          typename GridEntity >
class TestGridEntityGetter< tnlGrid< 3, Real, Device, Index >, GridEntity, 2 >
{
   public:
...
template< typename Real,
          ...
          typename Index,
          typename GridEntity >
class TestGridEntityGetter< tnlGrid< 3, Real, Device, Index >, GridEntity, 1 >
{
   public:
...
template< typename Real,
          ...
          typename Index,
          typename GridEntity >
class TestGridEntityGetter< tnlGrid< 3, Real, Device, Index >, GridEntity, 0 >
{
   public:
