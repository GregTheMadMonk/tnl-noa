...
class tnlMultidiagonalMatrixTester : public CppUnit :: TestCase
{
   ...
   void setLikeTest()
   {
      ...
      m1.setDiagonals( Vectors::tnlSharedVector< IndexType >( diagonalsShift, 5 ) );
      m2.setLike( m1 );
   ...
   void setValueTest()
   {
      ...
      m.setDiagonals( Vectors::tnlSharedVector< IndexType >( diagonalsShift, 7 ) );
      m.setValue( 1.0 );
   ...
   void matrixTranspositionTest()
   {
      ...
      m.setDiagonals( Vectors::tnlSharedVector< IndexType >( diagonalsShift, 6 ) );
